...
public class PlayerMovement : MonoBehaviour
{
	...
	public float jumpForce = 1.8f;          //Initial force of jump
	public float crouchJumpBoost = 2.0f;    //Jump boost when crouching
	public float hangingJumpForce = 12f;    //Force of wall hanging jump
	public float jumpHoldForce = 1.6f;      //Incremental force when jump is held
