...
public class ElevetorMovement : MonoBehaviour
{
    ...
    protected ElevetorMovement m_ParentCatcher;
    ...
    void Awake()
    {
        ...
        {
            ElevetorMovement catcher = currentParent.GetComponent<ElevetorMovement>();
            if (catcher != null)
                    ...
                    if (contactRigidbody.bodyType != RigidbodyType2D.Static && contactRigidbody != platformRigidbody)
                    {
                        ...
                        if (dot > 0.8f)
                        {
                            CaughtObject newCaughtObject = new CaughtObject
                            {
                                ...
                                character = contactRigidbody.GetComponent<PlayerMovement>(),
