...
public class AudioManager : MonoBehaviour
{
	...
	public AudioClip buttonVoiceClip;
	...
	public static void PlaycoinCollectionAudio()
	{
		...
		//Set the coin sting clip and tell the source to play
		current.stingSource.clip = current.coinpickupClip;
		current.stingSource.Play();

		//Set the coin voice clip and tell the source to play
		current.voiceSource.clip = current.coinpickupClip;
		current.voiceSource.Play();
	}
	public static void OnButtonClickAudio()
	{
		//If there is no current AudioManager, exit
		if (current == null)
			return;
		...
		//Set the coin sting clip and tell the source to play
		current.stingSource.clip = current.buttonVoiceClip;
		current.stingSource.Play();

		//Set the coin voice clip and tell the source to play
		current.voiceSource.clip = current.buttonVoiceClip;
		current.voiceSource.Play();
	}
